...
[oof, I wish I did it right the first time... going to take forever to port over all the symbols and comments, and it's not fun because all fun bits of figuring out what it's doing is already done!]
