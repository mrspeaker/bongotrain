...
---
29 pickups: 4 full sets of bonuses, max bonus = 10 + 20 + 30 + 40k = 100k
~100k for screens, + 100k for bonus  = ~200k max for one round.
----
...
But why the inconsistency? Always triggers on level 1->2, but more random on other screens. Should be random everywhere?
