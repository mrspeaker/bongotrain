...
16: S       right bottom center, vase top left
...
fast round - can jump from second-to-bottom

---
- what's that weird tiny "slowdown" right at the start?
- maybe the "impossible 3 bird" run - need to time it so the first pickup is your bonus
  
---
trav bug: die on screen one/two
---
q: what's that tiny delay lag right at the start?
